...
- **Dashboard Image:**  
  ➤ [sales_performance_dashboard.png](https://github.com/Davie7/Sales-Performance-Dashboard/blob/main/sales_performance_dashboard.png)
...
- Create a visually compelling dashboard.  
...
- A modern, dark-themed aesthetic  
